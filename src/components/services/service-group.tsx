...
function ServiceGroup({title, description, srv1, srv2, srv3, srv4, srv5, srv6, srv7, srv8, srv9, srv10, float}: serviceProps) {
    return (
        <section className={`w-screen h-auto flex flex-col items-${float} justify-start gap-16`}>
            <div className={'w-[80vw] h-auto bg-[#F7F7F7] flex flex-col items-${float} justify-start gap-16 pt-20'}>
                <div className={'flex flex-col items-start justify-start gap-12 px-[10%] '}>
                    ...
                    <div className={'flex flex-col items-start justify-start gap-6'}>
                        ...
                        <div className={'w-full flex flex-row items-start justify-start gap-32'}>
                            <div className={'flex flex-col items-start justify-start gap-6'}>
